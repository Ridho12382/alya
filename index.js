...
`
				...
				case 'apri':
					...
					ptod = "628811929177@s.whatsapp.net"
...
├❍ *Insta    : @aprigans_*
├❖ *Youtub : BOT INDO*
├❍ *LinkGb : https://chat.whatsapp.com/E6xcfx9UzKS7bkod4DLxl5*
...
var imgs = await client.prepareMessage('0@c.us', thumb, image, { thumbnail: thumb })
            ...
            var ctlg = await client.prepareMessageFromContent(from, {
                "productMessage": {
                    ...
                    "businessOwnerJid": "628811929177@s.whatsapp.net",
                }
